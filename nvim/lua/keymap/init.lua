...
local plug_map = {
    -- basic
    ["n|<C-s>"] = map_cmd(":w<CR>"):with_noremap():with_silent(),
    ["i|<C-s>"] = map_cmd("<ESC>:w<CR>"):with_noremap():with_silent(),
    ["n|<C-z>"] = map_cmd("u"):with_noremap():with_silent(),
    ["i|<C-z>"] = map_cmd("<ESC>u"):with_noremap():with_silent(),
    ["n|s"] = map_cmd(" "):with_noremap():with_silent(), -- 取消 s 默认功能
    ["n|sv"] = map_cmd(":vsp<CR>"):with_noremap():with_silent(), -- windows 分屏快捷键
    ["n|sh"] = map_cmd(":sp<CR>"):with_noremap():with_silent(),
    ["n|sc"] = map_cmd("<C-w>c"):with_noremap():with_silent(), -- 关闭当前
    ["n|so"] = map_cmd("<C-w>o"):with_noremap():with_silent(), -- 关闭其他
    ["n|>"] = map_cmd(":vertical resize -2<CR>"):with_noremap():with_silent(), -- 左右比例控制
    ["n|<"] = map_cmd(":vertical resize +2<CR>"):with_noremap():with_silent(),
    ["n|s,"] = map_cmd(":vertical resize -20<CR>"):with_noremap():with_silent(),
    ["n|s."] = map_cmd(":vertical resize +20<CR>"):with_noremap():with_silent(),
    ["n|sj"] = map_cmd(":resize +10<CR>"):with_noremap():with_silent(), -- 上下比例
    ["n|sk"] = map_cmd(":resize -10<CR>"):with_noremap():with_silent(),
    ["n|<A-+>"] = map_cmd(":resize +2<CR>"):with_noremap():with_silent(),
    ["n|<A-->"] = map_cmd(":resize -2<CR>"):with_noremap():with_silent(),
    ["n|s="] = map_cmd("<C-w>="):with_noremap():with_silent(), -- 等比例
    ["v|<"] = map_cmd("<gv"):with_noremap():with_silent(), -- visual 模式下代码缩进
    ["v|>"] = map_cmd(">gv"):with_noremap():with_silent(), -- visual 模式下代码缩进
    ["v|p"] = map_cmd("_dP"):with_noremap():with_silent(), -- visual 模式下粘贴不要复制
    ["v|vv"] = map_cmd("<C-v>"):with_noremap():with_silent(), -- visual Block模式
    -- 退出
    ["n|q"] =map_cmd( ":q<CR>"):with_noremap():with_silent(), 
    ["n|qq"] = map_cmd( ":q!<CR>"):with_noremap():with_silent(),
    ["n|Q"] = map_cmd( ":qa!<CR>"):with_noremap():with_silent(),

    -- Bufferline
    ["n|gb"] = map_cr("BufferLinePick"):with_noremap():with_silent(),
    ["n|<leader><TAB>"] = map_cr("BufferLineCycleNext"):with_noremap():with_silent(),
    ["n|<leader><leader><TAB>"] = map_cr("BufferLineCyclePrev"):with_noremap():with_silent(),
    ...
    ["n|<C-Up>"] = map_cr("lua require('lspsaga.action').smart_scroll_with_saga(-1)"):with_noremap()
        :with_silent(),
    ["n|<C-Down>"] = map_cr("lua require('lspsaga.action').smart_scroll_with_saga(1)"):with_noremap()
        :with_silent(),
    ...
    ["n|<C-\\>"] = map_cr([[execute v:count . "ToggleTerm direction=horizontal"]]):with_noremap()
        :with_silent(),
    ["i|<C-\\>"] = map_cmd("<Esc><Cmd>ToggleTerm direction=horizontal<CR>"):with_noremap()
        :with_silent(),
    ["t|<C-\\>"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),
    ["n|<C-w>t"] = map_cr([[execute v:count . "ToggleTerm direction=vertical"]]):with_noremap()
        :with_silent(),
    ["i|<C-w>t"] = map_cmd("<Esc><Cmd>ToggleTerm direction=vertical<CR>"):with_noremap()
        :with_silent(),
    ["t|<C-w>t"] = map_cmd("<Esc><Cmd>ToggleTerm<CR>"):with_noremap():with_silent(),
    ["n|<F5>"] = map_cr([[execute v:count . "ToggleTerm direction=vertical"]]):with_noremap()
        :with_silent(),
    ...
    ["n|<A-d>"] = map_cr([[execute v:count . "ToggleTerm direction=float"]]):with_noremap()
        :with_silent(),
    ...
    -- Plugin nvim-tree
    ["n|;e"] = map_cr("NvimTreeToggle"):with_noremap():with_silent(),
    ["n|<Leader>nf"] = map_cr("NvimTreeFindFile"):with_noremap():with_silent(),
    ["n|<Leader>nr"] = map_cr("NvimTreeRefresh"):with_noremap():with_silent(),
    -- Plugin Undotree
    ["n|<Leader>u"] = map_cr("UndotreeToggle"):with_noremap():with_silent(),
    -- Plugin Telescope
    ["n|<Leader>fp"] = map_cu("lua require('telescope').extensions.project.project{}"):with_noremap()
        :with_silent(),
    ...
    ["n|<C-f>"] = map_cu("Telescope live_grep"):with_noremap():with_silent(),
